...
HIVE_JARS=$HIVE_METASTORE:$HIVE_SERVICE:$HIVE_EXEC:$HIVE_JDBC:$HIVE_JACKSON:/opt/hive/lib/calcite-core-1.16.0.jar:/opt/hive/lib/libfb303-0.9.3.jar:/var/hoodie/ws/hudi-cli/target/lib/parquet-hadoop-1.12.3.jar:/var/hoodie/ws/hudi-cli/target/lib/parquet-column-1.12.3.jar:/var/hoodie/ws/hudi-cli/target/lib/parquet-common-1.12.3.jar:/var/hoodie/ws/hudi-cli/target/lib/parquet-format-structures-1.12.3.jar:/var/hoodie/ws/hudi-cli/target/lib/parquet-jackson-1.12.3.jar
...
echo "Running Command : java -cp  $HUDI_HIVE_UBER_JAR:${HADOOP_HIVE_JARS}:${HADOOP_CONF_DIR} org.apache.hudi.hive.HiveSyncTool org.apache.hudi.hive.HiveSyncTool $@"
